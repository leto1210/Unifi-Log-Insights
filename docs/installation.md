---
original_url: https://insightsplus.dev/docs/installation.html
...
- <a href="installation.html" class="block rounded-md px-2 py-1 text-sm transition-colors bg-primary/10 font-medium text-primary">Installation</a>
...
<div class="border-b border-border/50 bg-muted/80 px-4 py-2 text-xs font-medium text-muted-foreground">
