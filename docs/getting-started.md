---
original_url: https://insightsplus.dev/docs/getting-started.html
...
- <a href="getting-started.html" class="block rounded-md px-2 py-1 text-sm transition-colors bg-primary/10 font-medium text-primary">Prerequisites</a>
...
<div class="mt-8 space-y-6 text-[15px] leading-relaxed">
...
- **MaxMind GeoLite2 account** (<a href="https://www.maxmind.com/en/geolite2/signup" class="text-primary underline-offset-4 hover:underline" target="_blank" rel="noopener noreferrer">free signup</a>) - required for automatic GeoIP database updates. Without it, the container uses bundled GeoLite2 databases that work out of the box but will not auto-update
- **AbuseIPDB API key** (<a href="https://www.abuseipdb.com/register?plan=free" class="text-primary underline-offset-4 hover:underline" target="_blank" rel="noopener noreferrer">free tier</a>) - for threat scoring. 1,000 lookups/day + 5 blacklist pulls/day
