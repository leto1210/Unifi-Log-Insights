---
original_url: https://insightsplus.dev/docs/external-database.html
...
- <a href="external-database.html" class="block rounded-md px-2 py-1 text-sm transition-colors bg-primary/10 font-medium text-primary">External Database</a>
...
For step-by-step migration instructions, see the <a href="https://github.com/jmasarweh/unifi-log-insight/wiki/External-PostgreSQL-Migration-Guide" class="font-medium text-foreground underline underline-offset-4 hover:text-foreground/80" target="_blank" rel="noopener noreferrer">External PostgreSQL Migration Guide</a> on our GitHub wiki.
