---
original_url: https://insightsplus.dev/docs/unraid.html
...
- <a href="unraid.html" class="block rounded-md px-2 py-1 text-sm transition-colors bg-primary/10 font-medium text-primary">Unraid Setup</a>
...
|---------------------------------------------------------------------------------------|------------------------------------------------------|
| `POSTGRES_PASSWORD`<span class="ml-1.5 text-[10px] font-bold text-red-500">REQ</span> | PostgreSQL password. Choose a strong, unique value.  |
